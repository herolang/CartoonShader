Shader "Roystan/Toon CompleteHL"
{
	Properties
	{
		...
		//新增灯光强度
		_LightThresHold("Light Threshold", Range(0.5, 1)) = 1
		//新增阴影颜色
	...
	SubShader
	{
		Pass
		{
			...
			float4 frag (v2f i) : SV_Target
			{
				...
				//float4 col = (light*_LightThresHold + _AmbientColor + specular + rim) * _Color * sample;
				float4 col = (light*_LightThresHold + specular + rim) * _Color * sample;
				//菲涅尔效应
